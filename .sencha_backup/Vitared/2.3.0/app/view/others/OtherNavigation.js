/**
 * @class Vitared.view.others.OtherNavigation
 * @extends Vitared.view.home.NavigationHome
 * View of the others navigation
 * @author oswaldo@codetlan.com
 * @codetlan
 */
Ext.define('Vitared.view.others.OtherNavigation', {
    extend: 'Vitared.view.home.NavigationHome',
    xtype: 'othernavigation',

    requires: [
        'Ext.List',
        'Vitared.view.others.OtherTpl',
    ...
    initialize: function () {
        ...
        me.down('container').add([
            ...
            {
                xtype: 'list',
                itemTpl: Ext.create('Vitared.view.others.OtherTpl'),
                flex: 3,
                store: 'Others',
                masked: {
                    xtype: 'loadmask',
